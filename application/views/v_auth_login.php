...
<title>Log in | <?= get_informasi('nama'); ?></title>
...
<div class="login-logo">
	<a href="<?= base_url('assets/')?>index2.html"><b><?= get_informasi('nama');?></b></a>
</div>
<div class="card">
	...
	<input type="hidden" id="txt_csrfname" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
	...
	<p class="mb-1">
		<a href="<?= base_url('auth/lupa_password/')?>"><i>Lupa Password</i></a>
	</p>
	</div>
</div>
</div>
